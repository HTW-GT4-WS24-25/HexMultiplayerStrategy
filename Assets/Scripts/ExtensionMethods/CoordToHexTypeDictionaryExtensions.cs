...
namespace ExtensionMethods
{
    ...
    {
        public static int[] ToIntArray(this Dictionary<AxialCoordinates, ToppingType> map)
        {
            var nRings = map.Keys.Max(coord => coord.GetDistanceTo(AxialCoordinates.Zero));
            return ToIntArray(map, nRings);
        }
        
        public static int[] ToIntArray(this Dictionary<AxialCoordinates, ToppingType> map, int nRings)
        {
